 ...
 */
class HomeAdapter(private val context: Context?, data: MutableList<ArticleBean>):
        BaseQuickAdapter<ArticleBean, BaseViewHolder>(R.layout.item_home_list, data){
    ...
    override fun convert(helper: BaseViewHolder?, item: ArticleBean?) {
        ...
        tvFresh.visibility = if (item.fresh) View.VISIBLE else View.GONE
    }
}