package com.zyf.wanapp.http

import com.zyf.wanapp.App
import com.zyf.wanapp.BuildConfig
import com.zyf.wanapp.api.ApiService
import com.zyf.wanapp.constant.Constant
import com.zyf.wanapp.constant.HttpConstant
import com.zyf.wanapp.util.DelegateExt
import com.zyf.wanapp.util.NetWorkUtil
    ...
    private fun addHeaderInterceptor(): Interceptor {
        return Interceptor { chain ->
            ...
            val requestBuilder = originalRequest.newBuilder()
                    ...
                    .header("token", DelegateExt.token)
